---
title: "Thermally Reconfigurable Antennas & ENZ Media"
excerpt: "Phase-transition and epsilon-near-zero (ENZ) platforms for dynamic wavelength-scale antennas and beam shapers across the IR spectrum.<br/><img src='/images/500x300.png'>"
...
We're making this vision real using **phase-change materials** (VO₂, GST) and **epsilon-near-zero (ENZ) substrates** that amplify tiny perturbations into dramatic optical shifts. By depositing nanophotonic antennas onto ENZ films like doped indium oxide and cadmium oxide, we exploit extreme field confinement near the zero-index transition to achieve resonance shifts, Q-factor tuning, and radiation pattern reconfiguration with milliwatt-scale heating or modest voltages.

### Extreme tunability from exotic materials

**Ultrafast VO₂ switching** ― When vanadium dioxide transitions from insulator to metal, it doesn't do it halfway. Our metasurface modulators achieve >90% amplitude modulation at 2 μm wavelengths using femtosecond pump-probe switching—turning infrared light on and off faster than any mechanical or electro-optic device.

**ENZ amplification of thermo-optic effects** ― Conventional silicon antennas shift by ~0.1 nm per Kelvin. Boring. By coupling dielectric resonators to ENZ substrates, we've demonstrated 5 nm/V tuning (10× enhancement) while maintaining high Q-factors >150. The secret? ENZ materials concentrate fields so intensely that even tiny refractive index changes trigger massive resonance shifts.
...
> *Time-resolved modulation movies and ENZ dispersion plots will be added to the carousel.*
...
* **Publication:** [Thermally Reconfigurable Meta-Optics](/publication/2019-01-01-Thermally-Reconfigurable-Meta-Optics)
* **Publication:** [Ultrawide Thermal-Free-Carrier Tuning of Dielectric Antennas Coupled to ENZ Substrates](/publication/2017-09-01-ultrawide-thermal-free-carrier-tuning)
